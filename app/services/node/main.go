...
func run(log *zap.SugaredLogger) error {
	...
	fmt.Println(`    ____   _____ _    _    _    _   _    ____  _     ___   ____ _  ______ _   _    _    ___ _   _  `)
	fmt.Println(`   |  _ \ / ____| |  | |  / \  | \ | |  | __ )| |   / _ \ / ___| |/ / ___| | | |  / \  |_ _| \ | | `)
	fmt.Println(`   | |_) | (___ | |__| | / _ \ |  \| |  |  _ \| |  | | | | |   | ' / |   | |_| | / _ \  | ||  \| | `)
	fmt.Println(`   |  __/ \___ \|  __  |/ ___ \| |\  |  | |_) | |__| |_| | |___| . \ |___|  _  |/ ___ \ | || |\  | `)
	fmt.Println(`   |_|    |____/|_|  |_/_/   \_\_| \_|  |____/|_____\___/ \____|_|\_\____|_| |_/_/   \_\___|_| \_| `)
	fmt.Print("\n")
	...
	if err != nil {
		return fmt.Errorf("could not load genesis: %w", err)
	}
